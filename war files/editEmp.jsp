...
<table border="1">
<tr bgcolor="#33CCFF">
<th></th><th>Empid</th><th>EMPNAME</th><th>DOB</th><th>DOJ</th><th>DIVISION</th><th>GENDER</th><th>CTC</th>
...
{
%>
<form action="controller?name=editOneEmployee" method="post">
<div align="center">
<tr><td><input type="radio" name="emp" value=<%= eb.getEmpid()%> ></input></td>
